...
<head>
    ...
    <style>
        ...
        .styled-table {
            width: 80%;
            margin: 0 auto; /* جدول وسط‌چین شده */
            margin-top: 20px; /* فاصله مناسب از دکمه */
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container" style="padding: 20px">
            <!-- عنوان وسط‌چین شده -->
            <h3 style="text-align: center; margin-bottom: 40px;">نمایش دسته‌بندی‌ها</h3>
    
            <!-- بخش دکمه ایجاد دسته‌بندی -->
            <div class="header-section" style="text-align: center; margin-bottom: 30px;">
                <a href="/category/create" class="create-button">Create New Category</a>
            </div>
